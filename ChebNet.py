...
class ChebNet(torch.nn.Module):
    ...
    """
    def __init__(self, dim_in:int, dim_out:int, dim_h1:int=32, k:int=3, lr:float=0.001, wd:float=5e-4, logger=None):
        """
        Constructor
        """ 
        super().__init__()
        ...
        ### Define the model
        # Layer 1: Conv
        self.conv1 = ChebConv(in_channels=dim_in, out_channels=dim_h1, K=k)
        self.conv2 = ChebConv(in_channels=dim_h1, out_channels=dim_h1, K=k)
    ...
    def _print_info(self):
        ...
        """
        self._logger.info("++++++++++++++++++++++")
        self._logger.info("+++ Model: ChebNet +++")
        self._logger.info("++++++++++++++++++++++")
